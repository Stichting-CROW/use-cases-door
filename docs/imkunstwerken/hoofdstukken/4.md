...
## Inleiding
Dit hoofdstuk beschrijft met welke standaarden het model samenhangt, geordend per soort informatie zoals benoemd in de use cases.


## Mobiliteit en (inter)nationale veiligheid

### Bereikbaarheid en verkeersroutes
