...
In het onderzoek naar de staat en benutting van civiele kunstwerken van TNO [[prognose-vernieuwingsopgave-2023]] wordt uitgegaan van een vrij complexe methode van het bepalen van de opgave per kunstwerk, uiteengerafeld in de componenenten in figuur 3. De onderdelen daarvan worden beschreven in de onderstaande paragraven. Daarnaast bestaat een eenvoudiger methode, uitgewerkt door het project [Samen Slimmer Vervangen en Renoveren](#samen-slimmer-vervangen-en-renoveren), waarbij kunstwerken naar eevoudige constructiekenmerken worden gegroepeerd en als groep beoordeeld op basis van enkele constructieve berekeningen.
