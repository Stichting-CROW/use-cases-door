...
<figure>
<img src="../images/datadienst-beheerinformatie-nlcs.jpg" alt="visuele weergave van de datadienst tussen assetinformatiesysteem met Dataspecificatie realisatie en ontwerp, uitwisselen dataset van projectgebed en de nlcs-applicatie die deze transformeert naar een NLCS-tekening" width="100%"> 
...
<p><b>Aanbeveling DOOR-programma:</b> Stel landelijk vast welke informatie over de bestaande situatie nodig is voor het maken van een ontwerp. Maak hiervan een <b>"Dataspecificatie assetinformatie voor ontwerp en realisatie"</b> uitgedrukt in IMBOR/GWSW. </p>
...
<figure>
<img src="../images/datadienst-revisie.jpg" alt="visuele weergave van de datadienst tussen assetinformatiesysteem met Dataspecificatie revisie, uitwisselen dataset nieuwe situatie projectgebed en de nlcs-applicatie die een NLCS-revisietekening kan leveren met een revisiedataset erbij" width="100%"> 
