...
​
Het revisieproces is de combinatie van de dataflow "oplevering" van de opdrachtnemer naar het gemeentelijke projectteam en de dataflow "in beheer" van het projectteam naar de beheerder. Bij de gemeente Utrecht wordt ervan uitgegaan dat de informatiedrager een NLCS-revisietekening is, verrijkt met objectinformatie op basis van IMBOR.
