Dit document beschrijft de use case van gemeente Utrecht voor het uitwisselen van rioleringsinformatie tussen de beheerder en een projectteam (ingenieursbureau, aannemer) in het kader van het [=DOOR-programma=] <br><br>
**Inleiding**<br><br>
...
<li>Zorg ervoor dat bij de bestekstekening in NLCS direct een voorbeeld-revisiedataset beschikbaar is voor de aannemer; als gebouwd wordt volgens het bestek hoeft alleen de meting gedaan te worden, en kan de rest van de data onveranderd worden overgenomen in de revisiedataset. 
<li>Onderzoek of de aannemer overweg kan met de gehele Objecttypenbibliotheek bij het contract, of dat alleen alleen de velden die ingevuld moeten worden meegestuurd worden. Onderzoek ook welk uitwisselformaat hier het beste voor werkt. </ol>
