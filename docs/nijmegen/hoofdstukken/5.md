...
<br><br>
Een tweede belangrijk aandachtspunt is om de rioleringsbeheerder of een gespecialiseerde rioolopzichter tijdens de projectfasen "bouwrijp maken" en "woonrijp maken" direct de informatie-leveringen van de aannemer te laten toetsen en de toezichthouder te ondersteunen in zijn rol zodat gebreken in het informatiedossier bekend zijn voordat overgegaan wordt tot betaling. Het gaat specifiek om deze momenten in het project:
...
<figure>
<img src="../images/ontwerp.jpg" alt="visuele weergave van de stappen, geplot op de informatiestromen tussen 4 partijen: landelijke registyraties, beheerder, projectorganisatie opdrachtgever, opdrachtnemer">
<figcaption>De ontwerpstappen geplot op het algemene informatiestroomschema</caption>
</figure>

### Stap 1 Toetsen ontwerp en contract

* **Door wie:** Vakinhoudelijk specialist (rioleringsbeheerder)  
* **Advies aan organisatie:**  
  ...
  * Zorg dat het Handboek Inrichting Openbare Ruimte duidelijke eisen stelt voor het ontwerp en gebruiksvriendelijk is.
...
### Stap 2 Toetsen werk & uitvoeren meting tijdens en na realisatie bouwrijpfase
* **Door wie:** Aannemer  
* **Advies aan organisatie:**  
...
### Stap 3 Riool inspectie uitvoeren (voor het gat dichtgaat tijdens bouwrijp maken)
* **Door wie:** Toezichthouder + rioleringsbeheerder  
* **Advies aan organisatie:**  
  ...
  * Laat de rioleringsbeheerder (specialist) tijdens het werk direct meedraaien met werkvoorbereider (generalist) om de kwaliteit van inspecties te waarborgen.
...
* **Advies aan organisatie:**  
  ...
  * Onderzoek of je de volgende onderdelen kunt automatiseren:
    * Zorg ervoor dat de toezichthouder en rioleringsbeheerder inzicht hebben in het verschil in de locatie van objecten op de ontwerptekening met de revisietekening, zodat ze 
...
* **Door wie:** rioleringsbeheerder
* **Advies aan organisatie:**  
  * rioleringsbeheerder volgt de wettelijke termijn op voor aanlevering gegevens aan de KLIC
* **Advies mbt standaarden:** 
...
Landelijke ontwikkeling: Op dit punt is OPERA BV mede namens Stichting RIONED druk bezig met proefprojecten voor het deelmodel en het werkproces GWSW-Inmeten/Revisies, inclusief opleiding landmeters, validatie datasets, ILS, versterking rol directievoerders/projectleiders.
...
* **Door wie:** Toezichthouder + rioleringsbeheerder + Aannemer  
...
* **Door wie:**  
  * **Besluit:** Toezichthouder + rioleringsbeheerder  
...
* **Advies aan organisatiestandaarden:**  
  ...
  * Mogelijkheid om een deel van de opdrachtsom in te houden als het werk niet conform specificaties is opgeleverd. 
  ...
  Risico is dat aannemers bij hun calculatie al rekening gaan houden met niet-ontvangen laatste termijn. Dan schieten we er niets mee op. We moeten dus ook andere intrinsieke motivaties zoeken zodat aannemers zelf de projectdata en de revisies goed willen doen. Daarom is het goed samenwerken tidjens het project, en snelle controle van opgeleverde gegevens cruciaal. De aannemer krijgt hierdoor vroegtijdig mee welke urgentie dit heeft voor de gemeente, en heeft tijdens het werk nog de aandacht bij het project, waardoor het inwinnen en leveren van de gegevens makkelijker zal zijn dan achteraf.
