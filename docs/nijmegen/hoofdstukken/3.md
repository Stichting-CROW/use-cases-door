...
De werkgroep constateert dat het revisieproces zoals dat nu is bedacht, niet altijd goed wordt nageleefd in projecten. De metafoor die daarbij ontstond, is die van een voetbalteam: iedere speler moet duidelijk zijn taak kennen in het geheel, de informatie over assets moet goed overgespeeld worden en er is een coach nodig die de strategie (het revisieproces) steeds weer evalueert en onder de aandacht brengt van het voetbalteam, zeker als er sprake is van nieuwe spelers in het veld zoals nieuwe of tijdelijk ingehuurde collega’s of derde partijen die informatie leveren in publiek-private samenwerkingen. Een belangrijke speler is de toezichthouder, die daarvoor wel hulp van vakspecialisten / beheerders nodig heeft om te kunnen controleren of de datasets die opgeleverd worden kloppen. De beheerafdeling loopt nu achter met het controleren van revisiedossiers, wat er uiteindelijk voor zorgt dat er meer werk moet gebeuren om revisie te verwerken. Als het revisiedossier tijdig wordt gecontroleerd, kan verbetering van het dossier worden gedaan door de aannemer.  Een andere belangrijke speler is de aannemer. Er de laatste jaren niet genoeg opvolging geweest op dataleveringen door de aannemer, waardoor deze geen reden heeft om het contract uit te voeren. Door hier in de samenwerking aandacht voor te vragen en te controleren of dataleveringen op tijd worden aangeleverd, kan de projectleider zorgen voor betere naleving van het contract op het gebied van revisie. 
