...
2. Wegenbouwers – de partijen die verantwoordelijk zijn voor aanleg en onderhoud, en het PIM-samenwerkingsverband.
...
​
Het DOOR-programma, in samenwerking met de provincie Zuid-Holland, treedt op als korte termijn opdrachtgever. Binnen DOOR worden afspraken gemaakt over standaarden en uitwisselprotocollen, waarbij de provincie de use case heeft ingebracht.
Bij het Natianaal Platform Duurzame Wegen is een ander collectief van opdrachtgevers betrokken. Ook hiervandaan worden afsprake gemaakt over standaarden en uitwisselingsprotocollen.
De uitwisseling van geometrie van ontwerp en aanleg in het algemeen (niet alleen wegen maar de gehele openbare ruimte en infrastructuur) is een vraagstuk dat aansluit op het ontwikkeltraject van de NLCS naar Objectgericht.

Voor het ontwikkelen en beheren van een structurele oplossing is het noodzakelijk dat structurele financiering wordt gevonden voor duurzaam beheer van de weginfra-NL en de daarvan afgeleide datasepcificaties zoals het materialenpaspoort asfalt. 
